...
protected:
	...
	// App related props.
	EdsChar	_downloadFilePath[EDS_MAX_NAME];
	Bitmap* _evfBitmap;
	int  _evfWidth;
	int  _evfHeight;
...
public:
	...
	//Apps props
	void setDownloadFilePath( EdsChar *value )		{ strcpy_s( _downloadFilePath, value ); }
	void setEvfBitmap( Bitmap *value)				{ _evfBitmap = value; }
	void setEvfWidth( int value)					{ _evfWidth = value; }
	void setEvfHeight( int value)					{ _evfHeight = value; }
	...
	//Apps related props
	EdsChar *getDownloadFilePath()				{ return _downloadFilePath; }
	Bitmap  *getEvfBitmap() const				{ return _evfBitmap; }
	int		 getEvfWidth()						{ return _evfWidth;  } 
	int		 getEvfHeight()						{ return _evfHeight;  } 
